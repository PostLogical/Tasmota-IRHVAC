...
PLATFORM_SCHEMA = CLIMATE_PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_PI_OUTDOOR_SEED_HEAT, default=DEFAULT_PI_OUTDOOR_SEED_HEAT): vol.Coerce(float),
        vol.Optional(CONF_PI_OUTDOOR_SEED_COOL, default=DEFAULT_PI_OUTDOOR_SEED_COOL): vol.Coerce(float),
