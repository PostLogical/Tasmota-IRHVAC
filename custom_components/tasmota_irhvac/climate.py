...
class TasmotaIrhvac(RestoreEntity, ClimateEntity):
    ...
    def fan_modes(self):
        ...
        if HVAC_FAN_MAX_HIGH in self._attr_fan_modes and HVAC_FAN_AUTO_MAX in self._attr_fan_modes:
            new_fan_list = []
            for val in self._attr_fan_modes:
                if val == HVAC_FAN_MAX_HIGH:
                    new_fan_list.append(FAN_HIGH)
        ...
        if self._attr_preset_mode == PRESET_NONE:
            ...
            if self._attr_preset_mode == PRESET_POWERFUL:
                if not self._powerful:
                    ...
                    self._powerful = True
            elif self._attr_preset_mode == PRESET_ECONO:
                ...
                if not self._min_heat:
                    ...
                    self._turbo = "off"
                    self._clean = "off"
            elif self._attr_preset_mode == PRESET_SET_V:
                ...
                if self._swing_mode == SWING_BOTH:
                    ...
                    self._swing_mode = SWING_OFF
            elif self._attr_preset_mode == PRESET_SET_H:
